...
# NUM_ME_PAIRS_VALUES=(20)
# NUM_CO_PAIRS_VALUES=(0)
# LIKELY_PASSENGERS_VALUES=(100)
# TAU_LOW_VALUES=(0.15)
...
# TAU_LOW_VALUES=(0.15)
# TAU_HIGH_VALUES=(0.25)
# DRIVER_PROPORTIONS=($(seq 0.1 0.1 0.9))
# NUM_RUNS=5

# SIM TEST
# SUBTYPES=("UCEC")
# NUM_SAMPLES_VALUES=(100)
# NUM_ME_PAIRS_VALUES=(5)
# NUM_CO_PAIRS_VALUES=(0)
# LIKELY_PASSENGERS_VALUES=(5)
# TAU_LOW_VALUES=(0.15)
# TAU_HIGH_VALUES=(0.25)
# DRIVER_PROPORTIONS=(1.0)
# NUM_RUNS=1
