...
# SIMULATION GROUP 4: VARY COOCCURRENCE HYPERPARAMETERS
SUBTYPES=("UCEC" "BRCA" "LUAD")
NUM_SAMPLES_VALUES=(1000)
NUM_ME_PAIRS_VALUES=(0)
NUM_CO_PAIRS_VALUES=(5 10 15 20 25)
LIKELY_PASSENGERS_VALUES=(150)
TAU_LOW_VALUES=(0.005 0.020 0.045 0.95)
TAU_HIGH_VALUES=(0.015 0.030 0.045 0.105)
DRIVER_PROPORTIONS=(1.0)
NUM_RUNS=2
