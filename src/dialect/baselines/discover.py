...
def run_discover_for_interaction(
    ...
    """TODO: Add docstring."""
    # DISCOVER is an optional dependency; import lazily so this module still loads
    # (and the runner can skip the method) when it is not installed.
    from discover import pairwise_discover_test  # noqa: PLC0415
...
def run_discover_analysis(
    ...
    """TODO: Add docstring."""
    from discover import DiscoverMatrix  # noqa: PLC0415 (optional dependency)
